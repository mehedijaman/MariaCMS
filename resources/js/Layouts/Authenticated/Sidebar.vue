    ...
    <aside
        ...
        <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
            ...
            <ul class="space-y-2">
                ...
                <li v-bind:class="(route().current('menus.index') || route().current('menus.trash') || route().current('menu.items.index'))
                    ? 'bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600'
                    : 'border-b-[1px] border-gray-200 dark:border-gray-700 hover:bg-gray-300 dark:hover:bg-gray-700'
                    ">
                ...
                <li v-bind:class="(route().current('galleries.index') || route().current('galleries.trash') || route().current('gallery.items.index') || route().current('gallery.items.trash'))
                    ? 'bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600'
                    : 'border-b-[1px] border-gray-200 dark:border-gray-700 hover:bg-gray-300 dark:hover:bg-gray-700'
                    ">
                ...
                <li v-bind:class="(route().current('faqs.index') || route().current('faqs.trash'))
                    ? 'bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600'
                    : 'border-b-[1px] border-gray-200 dark:border-gray-700 hover:bg-gray-300 dark:hover:bg-gray-700'
                    ">
                ...
                <li v-show="can(['product read'])" v-bind:class="(route().current('products.index') || route().current('products.create') || route().current('products.edit') || route().current('products.trash'))
                    ...
                    <ShoppingBagIcon
                        class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white shadow-md" />
                    <span class="flex-1 ml-3 whitespace-nowrap">{{ lang().label.products }}</span>
                ...
                <li v-if="can(['hero read'])" v-bind:class="route().current('heroes.index')
                    ...
                    <WindowIcon
                        class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white shadow-md" />
                    <span class="flex-1 ml-3 whitespace-nowrap">{{ lang().label.heroes }}</span>
                ...
                <li v-if="can(['cta read'])" v-bind:class="route().current('cta.index')
                    ...
                    <Link :href="route('cta.index')"
                        class="flex items-center p-2 font-sans font-semibold text-sm  text-gray-900 rounded-sm dark:text-white  group">
                    <WindowIcon
                        class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white shadow-md" />
                    <span class="flex-1 ml-3 whitespace-nowrap">{{ lang().label.cta }}</span>
                ...
                <li v-bind:class="(route().current('videos.index') || route().current('videos.trash'))
                    ...
                    <VideoCameraIcon
                        class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white shadow-md" />
                    <span class="flex-1 ml-3 whitespace-nowrap">{{ lang().label.videos }}</span>

                    </Link>
                </li>

                <li v-bind:class="(route().current('clients.index') || route().current('clients.trash'))
                    ? 'bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600'
                    : 'border-b-[1px] border-gray-200 dark:border-gray-700 hover:bg-gray-300 dark:hover:bg-gray-700'
                    ">
