...
<template>
    ...
    <header class='shadow-md bg-white font-[sans-serif]'>
    <section
      ...
      <div class="absolute sm:right-10 right-4 flex items-center">
        <span class="relative sm:mr-8 mr-6">
    ...
    <div class='flex flex-wrap justify-center px-10 py-3 relative'>
      ...
      <ul id="collapseMenu" class='lg:!flex lg:space-x-10 max-lg:space-y-3 max-lg:hidden max-lg:w-full max-lg:my-4'>
