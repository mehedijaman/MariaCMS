...
const items = reactive(props.posts);
...
const updateItem = (id, updatedData) => {
    ...
    if (index !== -1) {
        ...
        items[index].content = updatedData.content;
        items[index].excerpt = updatedData.excerpt;
        items[index].password = updatedData.password;
        items[index].allow_comment = updatedData.allow_comment;
        items[index].is_featured = updatedData.is_featured;
        items[index].status = updatedData.status;
        items[index].meta_title = updatedData.meta_title;
        items[index].meta_description = updatedData.meta_description;
        items[index].meta_keywords = updatedData.meta_keywords;
    }
};
