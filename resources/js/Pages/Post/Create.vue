                    ...
                    <form class="space-y-2" @submit.prevent="submit">
                        <div class="space-y-1">
                            ...
                            <TextInput id="name" v-model="formData.name" type="text" class="block w-full"
                                autocomplete="name" :placeholder="lang().placeholder.post_name" :error="form.errors.name" />
                        ...
                        <div class="space-y-1">
                            ...
                            <TextInput id="slug" v-model="formData.content" type="text" class="block w-full"
                        ...
                        <div class="space-y-1">
                            ...
                            <select v-model="formData.is_featured" id="is_featured" name="is_featured" class="block w-full">
                                <option value="1">Yes</option>
                                <option value="0">No</option>
                            </select>
