...
const items = reactive(props.testimonials);
...
const updateItem = (id, updatedData) => {
    ...
    if (index !== -1) {
        ...
        items[index].designation = updatedData.designation;
        items[index].company = updatedData.company;
        items[index].rating = updatedData.rating;
