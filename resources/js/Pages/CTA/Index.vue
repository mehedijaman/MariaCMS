...
const form = useForm({
    ...
    buttonText: props.cta?.button_text,
    buttonURL: props.cta?.button_url,
    buttonTarget: props.cta?.button_target,
    _method: "PUT",
});
const update = () => {
    form.post(route("cta.update", props.cta?.id), {
        preserveScroll: true,
        onSuccess: () => null,
        onError: () => null,
        onFinish: () => null,
                ...
                <template #form class="grid grid-cols-6 gap-6 ">
                    ...
                    <div class="col-span-6 flex gap-4 w-full">
                        ...
                        <div class="w-1/2 h-fit">
                            ...
                            <ImageInput source="image" v-model="form.image" :image="props.cta.full_path_image"
