        ...
        <section class="py-12 sm:py-16">
            <div class="container mx-auto px-4">
                ...
                <label class="">
                    ...
                    <p class="peer-checked:bg-black peer-checked:text-white rounded-lg border border-black px-6 py-2 font-bold">{{ product.brand }}</p>
                    <span class="mt-1 block text-center text-xs">$80/mo</span>
                        ...
                        <!-- <div
                            ...
                            <div class="flex items-end">
                                <h1 class="text-3xl font-bold">${{ productStore.product.price }}</h1>
                                <span class="text-base">/month</span>
                            </div>

                            <button @click="cartStore.add(productStore.product)" type="button"
