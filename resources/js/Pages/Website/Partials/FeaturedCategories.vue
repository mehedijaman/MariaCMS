        ...
        <div class="max-w-7xl mx-auto px-4 py-12">
            <div class="mb-8">
                ...
                <h1 class="text-center text-2xl md:text-3xl font-bold py-4 text-gray-900">
                    FEATURED<span class="text-red-700"> CATEGORIES</span>
                </h1>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6">
                <div v-for="category in categories" :key="category.id"
                    class="shadow-lg rounded-sm bg-white flex flex-col justify-between pb-6">
                    <div class="border-b mb-4">
                        <img class="items-center mx-auto h-40 w-full" :src="category.media[0].original_url"
                            :alt="category.name">
