...
<body>
    ...
    <header class="header-area header-three">
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="call-box">
                                        ...
                                        <div class="text">
                                            <span>Email Now</span>
                                            <strong><a href="mailto:info@example.com"> iiustbbaipail@gmail.com
                                                </a></strong>
                                        </div>
                                    </div>
                                </li>
        ...
        <div class="container my-3">
            <div class="row">
                <div class="col">
                    <a href="index.html"> <img src="public/assets/frontend/images/main_logo_full.png" alt="full size logo"> </a>
                </div>
            </div>
        </div>
          ...
          <div class="offcanvas-menu">
             ...
             <div id="cssmenu3" class="menu-one-page-menu-container">
                <ul class="menu">
                   ...
                   <li class="menu-item menu-item-type-custom menu-item-object-custom"><a href="iiustb-club.html">IIUSTB Club</a></li>
             ...
             <div id="cssmenu2" class="menu-one-page-menu-container">
                <ul id="menu-one-page-menu-12" class="menu">
                   ...
                   <li class="menu-item menu-item-type-custom menu-item-object-custom"><a href="#howitwork"><span>Corporate Office: Square Bhabon, 1/B, DIT Avenue, Motijheel C/A, Dhaka-1000 </span></a></li>
                   <li class="menu-item menu-item-type-custom menu-item-object-custom"><a href="#howitwork"><span> Permanent Campus: Baipail, Ashulia, Dhaka-1349 </span></a></li>
                </ul>
             </div>
          </div>
                        ...
                        <div class="breadcrumb-wrap2">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Undergraduate Admission</li>
                                    </ol>
                                </nav>
                            </div>
                ...
                <div class="container">
					...
					<div class="col-lg-8 col-md-12 col-sm-12">
                            <div class="about-content s-about-content pl-15 wow fadeInRight   animated" data-animation="fadeInRight" data-delay=".4s" style="visibility: visible; animation-name: fadeInRight;">
                                <div class="row">
                                    <h5>IT Club </h5>
                                    <p>Motto: "Joy is the best makeup" </p>
                                    <p>Information Technology (IT) is the acquisition, processing, storage and dissemination of vocal, pictorial, textual and numerical information by a microelectronics based combination of computing and telecommunications. The term in its modern sense first appeared in a 1958 article published in the Harvard Business Review, in which authors Leavitt and Whistler commented that "the new technology does not yet have a single established name. We shall call it information technology.</p>
                                    <p>The IT Club is for the students, faculty members and staff who enjoy computers, programming, creating web page and like to geek-out, talk/learn and communicate. The objective is to provide assistance to the students and faculty regarding current IT systems (i.e. help sessions, correspondence, etc.). It is the goal of the IIUSTB IT Club to strive to create an environment conducive to the study in the respective field i.e. computer and telecommunication science. It facilitates members in obtaining materials (reference or other) that reinforce or augment materials presented in the classroom and/or assigned readings. The IIUSTB IT Club shall conduct monthly meetings for the members. In addition to these meetings, seminars related to the field of computer and telecommunication science shall be organized if desired by the members. The IIUSTB IT Club will facilitate (through guidance, funding, etc.) special interest groups for those members of the Club who wish to focus on a particular area of interest.</p> 
                                 </div>
                                <div class="row">
                                    <h5>Clture Club </h5>
                                    <p>Motto: "Were open to everyone on campus, not just music majors".</p>
                                    <p>Our goals are to enhance campus social life through music; promote, organize and encourage music events on campus; provide students with opportunities to perform in a live setting; build awareness of different kinds of music. Culture Club offers students a way to expose their talents to many. They play a crucial role in campus life, organizing many events on campus. Becoming a club member will not only bring great personal satisfaction but will also help to develop very useful organizational skills.</p>
                                </div>
                                <div class="row">
                                    <h5>Debating Club</h5>
                                    <p>Motto: IMPOSSIBLE" says itself that integrate University and community "I'M POSSIBLE"</p>
                                    <p>In our highly competitive world it is important to be able to present the ideas in a logical and convincing manner and debating helps to put forward logical thoughts to other. Formal debating introduces structure and rules to an exchange of opinions, giving each participant equal opportunity to present their side of the issue while attempting to prove the opposing side false. The primary commitment of the IIUSTB Debating Club is therefore to help its members improve these skills through extensive training programs and inter-University (including international) competitions, where we test our skills against the debaters from other institutions. We see the external competitions as both an opportunity to demonstrate our prowess, and learn from everyone else. At these debate competitions, you will meet some of the finest speakers of our generation</p>
                                </div>
                                <div class="row">
                                    <h5> Sports Club</h5>
                                    <p>Motto: "Try and try until you succeed" </p>
                                    <p>The club's overall objective is to train well-qualified players being able to take part in national teams and to play in the league. Successful sports players are granted with university scholarship and they are able to use all the facilities provided by the university. In addition, we assist improving all other branches by taking active role in the sports activities held at IIUSTB.</p>
                                </div>
                                <div class="row">
                                    <h5> Social Club</h5>
                                    <p>The motto of the club is to Promote awareness of cultural diversity by providing positive support unit for IIUSTB students and serve as a cultural, educational and social resource for the university. To promote, plan and integrate University and community activities that stimulates intellectual, social and moral growth of students. </p>
                                </div>
                                <div class="row">
                                    <h5>Environment Club </h5>
                                    <p>Motto: "It's impossible to fail, as long as you never quit"</p>
                                    <p>The objective is to offer the students of IIUSTB opportunity to discover and implement effective ways to protect and preserve the ecological environment in the campus and community.</p>
                                </div>
                                <div class="row">
                                    <h5>Recitation Club </h5>
                                    <p>Motto: "Where we prove creativity" </p>
                                    <p>The University's Students gain valuable experience in all aspects of creative production. Students interested in reciting for the people.</p>
                                </div>
                                <div class="row">
                                    <h5>Human Rights Club </h5>
                                    <p>Motto: "Live simply, Love generously, Care deeply, Speak kindly"</p>
                                    <p>The purpose is to raise awareness, create activities and discuss human rights violations around the world.</p>
                                </div>
                              </div>
                        </div>
                     <div class="col-lg-4 col-md-12 col-sm-12">
                         <div class="about-content s-about-content pl-15 wow fadeInRight   animated" data-animation="fadeInRight" data-delay=".4s" style="visibility: visible; animation-name: fadeInRight;">
                             <div class="sidebar_page_menu">
                                 <div class="menu-block-wrapper menu-block- menu-name-main-menu parent-mlid-2502 menu-level-">
                                      <ul class="menu clearfix">
                                          <li>
                                              <a href="academic-calendar.html" class="active-trail active">Academic Calendar</a>
                                          </li>
                                          <li>
                                              <a href="teaching-research.html">Teaching & Research</a>
                                          </li>
                                          <li>
                                              <a href="conferences-workshops.html">Conferences & Workshops</a>
                                          </li>
                                          <li>
                                             <a href="library.html">Library </a>
                                          </li>
                                          <li><a href="career-iiustb.html">Career at IIUSTB</a></li>
                                          <li><a href="iiustb-club.html">IIUSTB Club</a></li>
                                          <li><a href="faculty-staff.html">For Faculty & Staff</a></li>
                                      </ul>
                                  </div>
                               </div>
                                ...
                                <div class="recent-blog-footer">
                                    <ul>
                                        <li>
                                            ...
                                            <span>25 September, 2023</span></div>
                                        </li>
