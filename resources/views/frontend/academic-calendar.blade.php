...
<body>
    ...
    <header class="header-area header-three">
        ...
        <div class="container my-3">
            <div class="row">
                <div class="col">
                    <a href="index.html"> <img src="public/assets/frontend/images/main_logo_full.png"
                            alt="full size logo"> </a>
                </div>
            </div>
        </div>
    ...
    <main>
        ...
        <section class="breadcrumb-area d-flex  p-relative align-items-center"
            style="background-image:url(public/assets/frontend/images/vice-banner.jpg)">
                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="about-content s-about-content pl-15 wow fadeInRight   animated"
                            ...
                            <p>International Islami University of Science and Technology Bangladesh will carefully
                                prepare and strictly maintain the Academic Calendar from the beginning to ending of a
                                semester. Faculty members will provide lesson plan, class routine, the dates of
                                examination, etc. to the students. The University will offer three semesters in each
                                academic year.</p>
                            <table class="rtable">
                                <tr>
                                    <td>Spring Semester</td>
                                    <td>:</td>
                                    <td>From first week of January to last week of June.</td>
                                </tr>
                                <tr>
                                    <td>Fall Semester</td>
                                    <td>:</td>
                                    <td>From first week of July to last week of December.</td>
                                </tr>
                            </table>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center align-items-center" style="margin-top: 20px">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="about-content s-about-content pl-15 wow fadeInRight   animated"
                            ...
                            <p>Grading Scheme suggested by UGC will follow as the grading scheme for IIUSTB as stated
                                below:</p>
                            <table class="rtable">
                                <thead>
                                    <tr>
                                        <th style="text-align: center">Numerical Grades</th>
                                        <th colspan="2" style="text-align: center">Letter Grades</th>
    ...
    <footer class="footer-bg footer-p pt-90"
        style="background-color: #125875; background-image: url(public/assets/frontend/images/footer-bg.png);">
                        ...
                        <div class="footer-widget mb-30">
                            ...
                            <div class="recent-blog-footer">
                                <ul>
                                    <li>
                                        <div class="thum"> <img
                                                src="public/assets/frontend/images/blog/s-blogimg-01.png" alt="img">
                                        </div>
                                    ...
                                    <li>
                                        <div class="thum"> <img
                                                src="public/assets/frontend/images/blog/s-blogimg-02.png" alt="img">
                                        </div>
                                        <div class="text"> <a href="blog-details.html">Nothing impossble to need hard
                                                work</a>
                                            <span>25 September, 2023</span>
