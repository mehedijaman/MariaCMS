                        ...
                        <div class="breadcrumb-wrap2">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Scholarship / Financial Aid</li>
                                    </ol>
                                </nav>
                            </div>
            ...
            <section class="about-area about-p pt-120 pb-120 p-relative fix">
                ...
                <div class="container">
					...
					<div class="col-lg-8 col-md-12 col-sm-12">
                            ...
                            <p>Result based waiver for the students of bachelors programs only</p>
                                <table class="rtable tuition-fees">
                                    <thead>
                                        <tr>
                                            <th>Results of SSC & HSC </th>
                                            <th>Waiver</th>
                                        </tr>
                                    </thead>    
                                    <tbody>
                                        <tr>
                                            <td>Golden GPA 5.00 (in both) </td>
                                            <td>100%</td>
                                        </tr>
                                        <tr>
                                            <td>Only GPA 5.00 (in both) </td>
                                            <td>60%</td>
                                       </tr>
                                        <tr>
                                            <td>GPA 4.80 - 4.99 (in both) </td>
                                            <td>50%</td>
                                       </tr>
                                        <tr>
                                            <td>GPA 4.50 - 4.79 (in both) </td>
                                            <td>30%</td>
                                        </tr>
                                        <tr>
                                            <td>GPA 4.00 - 4.49 (in both)  </td>
                                            <td>20%</td>
                                        </tr>
                                        <tr>
                                            <td>GPA 3.50 - 3.99 (in both) </td>
                                            <td>10%</td>
                                        </tr>
                                        <tr>
                                            <td>Bellow 3.5  </td>
                                    ...
                                    <ul class="financial-assistance">
                                        <li>* Special 5% scholarship on tuition fee for Female & tribal. </li>
                                        <li>* 20% scholarship on tuition fee for Siblings. </li>
                                        <li>* Special waiver for wards of Freedom Fighters.  </li>
                                        <li>* Admission test may be exempted based on combined GPA in SSC & HSC.    </li>
                                        <li>* The University Authority reserves the rights to change the fee structure at any time.   </li>
                                    </ul>
                                </div>
                                
                                <div class="row" style="margin-top: 50px;">
                                    <h5>Poucy for Merit Scholarship </h5>
                                    <p>Merit scholarship (based on semester final results) will be granted under conditions stated below: </p>
                                    <ul class="financial-assistance" style="margin-top: 0">
                                        <li>* Minimum size of the class is 40 (students), </li>
                                        <li>* Minimum load of a student is 15 credit hours </li>
                                        <li>* Minimum CGPA for availing the merit scholarship is 3.75  </li>
                                        <li>* A Student must clear all dues to avail the scholarship.   </li>
                                    </ul>
                                </div>
