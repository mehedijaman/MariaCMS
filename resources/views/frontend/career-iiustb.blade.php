                        ...
                        <div class="breadcrumb-wrap2">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Career at IIUSTB</li>
                                    </ol>
                                </nav>
                            </div>
                ...
                <div class="container">
					...
					<div class="col-lg-8 col-md-12 col-sm-12">
                            <div class="about-content s-about-content pl-15 wow fadeInRight   animated" data-animation="fadeInRight" data-delay=".4s" style="visibility: visible; animation-name: fadeInRight;">
                                <div class="row">
                            <h5>Career Scope </h5>
                            <p>The degree offers student the opportunity for pursuing careers in the business world, either a managers, entrepreneurs functional specialists in areas, for example, finance, banking, marketing human resource management, etc</p>
                                </div>
                                <div class="row">
                                    <h5>Industrial Linkage </h5>
                                    <p><b>1. </b>Masco Group</p>
                                    <p><b>2. </b>Fakir Knitwear </p>
                                    <p><b>3. </b>Fakir Knitwear </p>
                                    <p><b>4. </b>Standard Bank Limited </p>
                                </div>
