                ...
                <div class="container">
					...
					<div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="about-content s-about-content pl-15 wow fadeInRight   animated" data-animation="fadeInRight" data-delay=".4s" style="visibility: visible; animation-name: fadeInRight;">
                                <div class="row">
                                <h5>Approved courses as follows:</h5>
                                <table class="rtable">
                                    <thead>
                                        <tr>
                                            <th>Sl No</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td rowspan="2">1</td>
                                            <td rowspan="2">Faculty of Religious Science</td>
                                            <td>1. BA (Hons) in Al Quran and Islamic Studies</td>
                                        </tr>
                                        <tr>
                                            <td>2. MA in Al Quran and Islamic Studies</td>
                                        </tr>
                                        <tr>
                                            <td rowspan="2">2</td>
                                            <td rowspan="2">Faculty of Science and Engineering</td>
                                            <td>1. B. Sc in Computer Science and Engineering</td>
                                        </tr>
                                        <tr>
                                            <td>2. B. Sc in Electrical and Electronic Engineering</td>
                                        </tr>
                                        <tr>
                                            <td rowspan="2">3</td>
                                            <td rowspan="2">Faculty of Business Administration</td>
                                            <td>1. Bachelor of Business Administration</td>
                                        </tr>
                                        <tr>
                                            <td>2. Master of Business Administration (1-year & 2-year)</td>
                                        </tr>
                                ...
                                <div class="row" style="margin-top: 50px">
                                    <h5>Lab Facility</h5>
                                    <p><b>1.</b> Computer Lab</p>
                                    <p><b>2.</b> Communication Lab</p>
                                    <p><b>3.</b> Digital & Microprocessor Lab</p>
                                    <p><b>4.</b> Drawing Lab</p>
                                    <p><b>5.</b> Electronics & Circuit Lab</p>
                                    <p><b>6.</b> Machine Lab</p>
                                    <p><b>7.</b> Switchgear & Protection Lab</p>
                                    <p><b>8.</b> Physics Lab</p>
                                    <p><b>9.</b> Chemistry Lab</p>
                                </div>
                            </div>
                        </div>
