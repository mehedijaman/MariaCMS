                        ...
                        <div class="breadcrumb-wrap2">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Postgraduate Admission</li>
                                    </ol>
                                </nav>
                            </div>
                ...
                <div class="container">
					...
					<div class="col-lg-8 col-md-12 col-sm-12">
                            <div class="about-content s-about-content pl-15 wow fadeInRight   animated" data-animation="fadeInRight" data-delay=".4s" style="visibility: visible; animation-name: fadeInRight;">
                                <div class="row">
                            <h5>MA in Al Quran & Islamic Studies  </h5>
...
<p><b>3.</b> For applicants from foreign countries similar standard should be maintained. Arabic &English are the primary languages used as the medium of instruction in the University.</p>
                                ...
                                <div class="row">
                                    ...
                                    <p>The objective of the admission policy is to first-rate students on a competitive basis for the program. A student is selected for admission on the basis of past academic records, performance in admission test, and viva-voce. The candidates must have at least a three-year bachelor degree with non-business academic background eligible for the program.</p>
                                </div>
                            </div>
                        </div>
