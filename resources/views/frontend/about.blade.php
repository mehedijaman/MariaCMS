            ...
            <section class="about-area about-p pt-120 pb-120 p-relative fix">
                ...
                <div class="container">
                    ...
                    <div class="row justify-content-center align-items-center">
                         <div class="col-lg-12 col-md-12 col-sm-12">
                              <div class="about-content s-about-content wow fadeInRight   animated" data-animation="fadeInRight" data-delay=".4s" style="visibility: visible; animation-name: fadeInRight;">
                                    <h5>Land and Location</h5>
                                    <p><strong style="color: #777">The International Islami University of Science and Technology Bangladesh (IIUSTB) will initially be started in a 4 storied own building in an excellent area of Dhaka district of Bangladesh, so that the students, staffs and faculty members can reach there easily. Present address and the floor space of the proposed university are given below :</strong></p>
                                    <table class="rtable">
                                        <tr>
                                            <td>Address</td>
                                            <td>:</td>
                                            <td>Baipail, PO- Gazirchat Alia Madrasah, UP- Dhamsuna, PS-Ashulia, Dhaka</td>
                                        </tr>
                                        <tr>
                                            <td>Floor space</td>
                                            <td>:</td>
                                            <td>6700 sft per floor</td>
                                        </tr>
                                        <tr>
                                            <td>Status of Possession </td>
                                            <td>:</td>
                                            <td>Own</td>
                                        </tr>
                                    </table>
                                    <p style="margin-top: 20px"><strong style="color: #777">The address and land area of the permanent campus is given below :</strong></p>
                                    <table class="rtable">
                                        <tr>
                                            <td>Address</td>
                                            <td>:</td>
                                            <td>Mouza - Baipail, Sub Registry Office – Ashulia, PS- Ashulia, Dist – Dhaka.</td>
                                        </tr>
                                        <tr>
                                            <td>Total Land</td>
                                            <td>:</td>
                    ...
                    <div class="row justify-content-center align-items-center" style="margin-top: 50px;">
                         <div class="col-lg-12 col-md-12 col-sm-12">
                              <div class="about-content s-about-content wow fadeInRight   animated" data-animation="fadeInRight" data-delay=".4s" style="visibility: visible; animation-name: fadeInRight;">
                                    <h5>Statutory Bodies</h5>
                                    <p>The highest policy making body of the university is the Board of Trustees. The Board of Trustees as per Act and Statutes of the university will constitute the executive body of the university. All officers, Faculty Members and other employees will be appointed as per Act and Statutes. The Academic Council and other bodies will be formed in due course as per Act and Statutes of the university.</p>
                                    <p>The Honorable President of the People’s Republic of Bangladesh will be the Chancellor of International Islami University of Science and Technology Bangladesh as per the Private University Act, 2010. It shall be an independent autonomous body having full academic freedom. University will have a fulltime Vice-Chancellor, a Pro Vice Chancellor and Treasurer to be appointed by the Honorable President of the People’s Republic of Bangladesh and the Chancellor of the University.</p>
                                    <p>The International Islami University of Science and Technology Bangladesh will be governed as usual under the Private University Act 2010 with ordinance and statutes to be formed by the university from time to time as and when necessary, in respect of composition of administration, teaching, research and functionary personnel. The execution of the policies laid down and approved by the Board of Trustees will be the responsibility of the Syndicate. However, Board of Trustees of the university will work in accordance with the provisions of the Private University Act 2010.</p>
                              </div>        
                         </div>       
                    </div>  
                </div>
