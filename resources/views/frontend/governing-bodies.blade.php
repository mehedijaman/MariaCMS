                        ...
                        <div class="breadcrumb-wrap2">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Syndicate</li>
                                    </ol>
                                </nav>
                            </div>
            ...
            <section class="about-area about-p pt-120 pb-120 p-relative fix">
                ...
                <div class="container">
					...
					<div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="syndicate about-content s-about-content pl-15 wow fadeInRight   animated" data-animation="fadeInRight" data-delay=".4s" style="visibility: visible; animation-name: fadeInRight;">
                                <p>The Syndicate is the highest policy making body of International Islami University of Science and Technology Bangladesh. The Vice-Chancellor is the Chairperson and others are the members of the Syndicate. The following members comprise the body:</p>
                                <ul>
                                <li><span class="number">1</span> Vice-Chancellor</li> 
                                <li><span class="number">2</span> Pro Vice-Chancellor</li> 
                                <li><span class="number">3</span> Treasurer</li> 
                                <li><span class="number">4</span> Three members from the Board of Trustees</li> 
                                <li><span class="number">5</span> One member from Academic Council nominated by Vice-Chancellor</li> 
                                <li><span class="number">6</span> One Senior most Dean nominated by Vice-Chancellor</li> 
                                <li><span class="number">7</span> An Educationist nominated by the Govt.</li> 
                                <li><span class="number">8</span> One representative preferably a professor nominated by UGC.</li> 
                                <li><span class="number">9</span> Registrar of IIUSTB.</li> 
                                </ul>
                                <p>The Registrar of the University will act as Secretary of the Syndicate.</p>
                            </div>
                        </div>
